...
data = cl_price.head(8) #prints the first 8 rows of the dataframe
print(data)
cl_price.tail() #prints the last 5 rows of the dataframe
data = cl_price.describe() #performs summary statistic of each numerical columns in the datafrme
print(data)
